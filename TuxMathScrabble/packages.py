...
def mkpkgs(w,h):
		...
		package=[
			...
			[ 5.0, 0.1,     1, 999, 999, 999, 999,  50,   20,     0, twopi,  30,  200,  55, 000, 000, 255, 000,  2,   10,  5,  2,  True,   True,   True],
		]
		...
		# tblow,dtblow,radius,  x0, dx0,  y0, dy0,   v,   dv, theta,dtheta,  ay,    r,  dr,   g,  dg,   b,  db,ttl,   tl,  n, dn,  ring,   tail colorlock
			...
			[ 3.5, 0.0,    	2, 999, 999, 999, 999,  30,   20,     0, twopi,  30,  255, 000, 000, 000, 000, 000,  2,	  25, 20,  5, False,   True,   True],
		...
		package=[
		# tblow,dtblow,radius,  x0, dx0,  y0, dy0,   v,   dv, theta,dtheta,  ay,    r,  dr,   g,  dg,   b,  db,ttl,   tl,  n, dn,  ring,   tail colorlock
			[ 0.0,  .1,     1, w/2,   0,   h,   0,-180,   35, piov2,pi/20.,  30,  200, 000, 200, 000, 000, 000,  5,	   1,  1, 00, False,   False,   True],
			[ 2.5, 0.1,    	2, 999, 999, 999, 999,  10,    5,     0, twopi,  30,  200, 000, 100,  10, 000, 000,  3,	  10, 25,  1, False,    True,   True],
			[ 5.2, 0.0,    	1, 999, 999, 999, 999,  10,   10,     0, twopi,  30,  235,  20, 235,  20, 235,  20,  4,	  00, 15,  5, False,   False,   True],
		]
		pkgs.append({desc:package})
		...
		# tblow,dtblow,radius,  x0, dx0,  y0, dy0,   v,   dv, theta,dtheta,  ay,    r,  dr,   g,  dg,   b,  db,ttl,   tl,  n, dn,  ring,   tail colorlock
			...
			[ 2.5, 0.2,    	3, 999, 999, 999, 999,   4,    2,     0, twopi,  30,  255, 000, 255, 000, 255, 000,  4,	  20, 15,  2, False,    True,   True],
			[ 5.0, 0.0,    	1, 999, 999, 999, 999,  30,    0,     0, twopi,  30,  200,  55, 200,  55,  50,  50,  2,	   0, 10,  5, False,   False,  False],
		]
		pkgs.append({desc:package})
		...
		# tblow,dtblow,radius,  x0, dx0,  y0, dy0,   v,   dv, theta,dtheta,  ay,    r,  dr,   g,  dg,   b,  db,ttl,   tl,  n, dn,  ring,   tail colorlock
			...
			[ 3.6, 0.0,    	1, 999, 999, 999, 999,   0,    0,     0,     0,  30,  100, 000, 100, 000, 255, 000,  3,	  20,  1,  0, False,   True,   False],
		]
		pkgs.append({desc:package})
		...
		# tblow,dtblow,radius,  x0, dx0,  y0, dy0,   v,   dv, theta,dtheta,  ay,    r,  dr,   g,  dg,   b,  db,ttl,   tl,  n, dn,  ring,   tail colorlock
			...
			[ 4.0, 0.0,    	3, 999, 999, 999, 999,  80,   10,     0, twopi,  30,  100,  55, 100,  55, 255, 000,  3,	  15, 50, 20, False,   True,   False],
		]
		pkgs.append({desc:package})
		...
		# tblow,dtblow,radius,  x0, dx0,  y0, dy0,   v,   dv, theta,dtheta,  ay,    r,  dr,   g,  dg,   b,  db,ttl,   tl,  n, dn,  ring,   tail colorlock
			...
			[ 4.5,  .1,    	2, 999, 999, 999, 999,  10,    1,     0, twopi,  30,  200, 000, 255, 000, 200, 000,  3,	   3,  2,  1, False,   True,   True],
		]
		pkgs.append({desc:package})
		...
		# tblow,dtblow,radius,  x0, dx0,  y0, dy0,   v,   dv, theta,dtheta,  ay,    r,  dr,   g,  dg,   b,  db,ttl,   tl,  n, dn,  ring,   tail colorlock
			[ 0.0,  .1,     3, w/2,   0,   h,   0,-155,    5, piov2,pi/30.,  30,  255, 000, 255, 000, 255, 000,  5,	  20,  1,  0, False,  False,  False],
			[ 3.0, 0.1,    	2, 999, 999, 999, 999,  10,    5,     0, twopi,  30,  000, 000, 000, 000, 200, 000,  3,	   5, 20, 10,  True,   True,   True],
